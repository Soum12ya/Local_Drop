...
Revision ID: 23a2fdbf2ec1
Revises: 
Create Date: 2026-09-02 11:39:49.538344
...
def upgrade() -> None:
    ...
    #op.create_index('idx_sellers_location', 'sellers', ['location'], unique=False, postgresql_using='gist')
...
def downgrade() -> None:
    ...
    op.drop_index('idx_sellers_location', table_name='sellers', postgresql_using='gist')
